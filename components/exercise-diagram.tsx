...
const MEDIA_BY_NAME: Record<string, { start: string; peak?: string }> = {
  "划船机上肢热身": { start: "rowing-machine-start.webp", peak: "rowing-machine-peak.webp" },
  "上斜俯卧撑": { start: "incline-push-ups-start.webp", peak: "incline-push-ups-peak.webp" },
  "绳索肩外旋": { start: "cable-external-rotation-start.webp", peak: "cable-external-rotation-peak.webp" },
  "弹力带肩部拉伸": { start: "banded-shoulder-stretch-main.webp" },
  "穿针式胸椎旋转": { start: "thread-the-needle-main.webp" },
  "肩后侧横拉": { start: "cross-body-shoulder-stretch-main.webp" },
  "跑步机坡度走": { start: "incline-treadmill-walk-main.webp" },
  "徒手早安式": { start: "bodyweight-good-morning-start.webp", peak: "bodyweight-good-morning-peak.webp" },
  "弹力带侧向走": { start: "banded-lateral-walk-start.webp", peak: "banded-lateral-walk-peak.webp" },
  "站姿股四头肌拉伸": { start: "standing-quad-stretch-main.webp" },
  "墙面小腿拉伸": { start: "standing-calf-stretch-main.webp" },
  "长凳内收肌拉伸": { start: "bench-adductor-stretch-main.webp" },
  "固定自行车轻骑": { start: "stationary-bike-main.webp" },
  "肩胛引体向上": { start: "scapular-pull-ups-start.webp", peak: "scapular-pull-ups-peak.webp" },
  "猫牛式": { start: "cat-cow-main.webp" },
  "长凳婴儿式": { start: "bench-childs-pose-main.webp" },
  "穿针式上背拉伸": { start: "thread-the-needle-main.webp" },
  "颈侧温和拉伸": { start: "neck-side-stretch-main.webp" },
